...
def gen_bash_command(docstring_info: DocstringInfo, output_path: str, python_script_path: str):
    python_cmd_relative_path = relpath(python_script_path, get_git_top_dir(cwd=dirname(output_path)))
    info = get_bash_template_data(docstring_info, python_cmd_relative_path)
